...
if(isset($_REQUEST['submit']))
{
   ...
   if (($_FILES["img"]["size"]) > 500000000) {
    ...
    if ($image != "pdf" && $image != "doc" && $image != "docx" && $image != "jpeg") {
            echo ("<SCRIPT LANGUAGE='JavaScript'>
                    window.alert('Only pdf, doc, jpeg and docx files are allowed.')
                    </SCRIPT>");
        $u = 0;
    }
    else {
        if (isset($u) == 0) {
            ...
            mysql_query("INSERT INTO lessonsyllabus VALUES(0,'English','$target_file')");
        } else {
                echo ("<SCRIPT LANGUAGE='JavaScript'>
  ...
  <head>
    ...
    <script>
        ...
        //Create Labels
            ...
            label.innerHTML = "Lesson Syllabus";     
            ...
            <nav id="tf-menu" class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand logo" href="#"> Lesson Syallbus </a>
                    </div>

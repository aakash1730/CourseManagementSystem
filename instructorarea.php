        ...
        <div class="overlay">
                    ...
                    <div class="navbar-header">
                     ...
                     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="instructorinfo.php">Profile</a></li>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <h3>Teach the Courses <br> & <br> Enjoy it with Students !!! </h3>
                    <br>
          <br>
                    
                    <a href="#tf-portfolio" class="btn btn-primary my-btn">Contribute to a Course</a>
          <br>
          <a href="tf-contact" class="btn btn-primary my-btn">About Us</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="" target="_blank">
          ...
          <div class="caption">
            <p><a href="englishupdate.php" class="btn btn-primary my-btn dark" role="button" aria-disabled="true">English</a></p>
          </div>
        </a>
      </div>
    </div>

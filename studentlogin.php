...
if($_POST)
{
    ...
    $result = mysql_query("SELECT * from student where Email = '$Email' and Password = '$password'") or die("Failed to query Database." .mysql_error());
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form id="contact" method="post">
                      <div class="form-group">
                        <input type="text" name="Email" required autocomplete="off" class="form-control" id="Email" placeholder="Enter Email-ID">
                      </div>
                      <div class="form-group">

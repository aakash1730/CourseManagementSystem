   ...
   if (($_FILES["img"]["size"]) > 500000000) {
    ...
    if ($image != "pdf" && $image != "doc" && $image != "docx") {
        ...
        if (isset($u) == 0) {
            ...
            mysql_query("INSERT INTO lessontutorial VALUES(0,'English','$target_file')");
        } else {
                echo ("<SCRIPT LANGUAGE='JavaScript'>
  ...
  <head>
    ...
    <script>
        ...
        //Create Labels
            ...
            label.innerHTML = "Lesson Tutorial";     
            
            //Assign different attributes to the element.
            label.setAttribute("align","left");
            element.setAttribute("type", "file");
            element.setAttribute("value", "");
            element.setAttribute("name", "Tutorial");
            ...
            <nav id="tf-menu" class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand logo" href="#"> Lesson Tutorial </a>
                    </div>

...
if(isset($_REQUEST['submit']))
{
   ...
   if (($_FILES["img"]["size"]) > 500000000) {
    ...
    if ($image != "ppt") {
            echo ("<SCRIPT LANGUAGE='JavaScript'>
                    window.alert('Only ppt files are allowed.')
                    </SCRIPT>");
        $u = 0;
    }
    else {
        if (isset($u) == 0) {
            ...
            mysql_query("INSERT INTO lessonppt VALUES(0,'English','$target_file')");
        } else {
                echo ("<SCRIPT LANGUAGE='JavaScript'>
  ...
  <head>
    ...
    <script>
        ...
        //Create Labels
            ...
            label.innerHTML = "Lesson Ppt";     
            
            //Assign different attributes to the element.
            label.setAttribute("align","left");
            element.setAttribute("type", "file");
            element.setAttribute("value", "");
            element.setAttribute("name", "Ppts");
            ...
            <nav id="tf-menu" class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand logo" href="#"> Lesson PPt </a>
                    </div>
